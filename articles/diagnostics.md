...
#>   (BC = bias-corrected using model-based variance)
#>                       Observed Estimate Estimate (BC) CI lower CI upper
#> year=2019, sex=Female    1,535   27,955        25,517   12,623   51,582
#> year=2019, sex=Male      5,069   82,627        74,997   35,447  158,675
#> year=2020, sex=Female      698   19,983        17,972    6,689   48,289
#> year=2020, sex=Male      2,700   57,369        51,229   18,647  140,737
#> year=2021, sex=Female      483   82,824        71,949   23,992  215,769
#> year=2021, sex=Male      2,622  256,906       221,274   71,020  689,415
#> year=2022, sex=Female      317   38,118        34,314    7,886  149,304
#> year=2022, sex=Male      2,632   89,842        81,616   20,778  320,585
#> year=2023, sex=Female      523   66,773        60,521   20,202  181,306
#> year=2023, sex=Male      3,839  159,329       145,958   52,561  405,312
#> year=2024, sex=Female      956  120,770       110,590   46,314  264,067
#> year=2024, sex=Male      5,731  302,530       279,303  120,576  646,982
```
