...
- [`logLik(`*`<uncounted>`*`)`](https://ncn-foreigners.github.io/uncounted/reference/logLik.uncounted.md)
...
- [`nobs(`*`<uncounted>`*`)`](https://ncn-foreigners.github.io/uncounted/reference/nobs.uncounted.md)
  : Number of observations for uncounted models
- [`plot(`*`<uncounted>`*`)`](https://ncn-foreigners.github.io/uncounted/reference/plot.uncounted.md)
  : Diagnostic plots for uncounted models
- [`plot(`*`<uncounted_loo>`*`)`](https://ncn-foreigners.github.io/uncounted/reference/plot.uncounted_loo.md)
...
- [`summary(`*`<uncounted_boot>`*`)`](https://ncn-foreigners.github.io/uncounted/reference/summary.uncounted_boot.md)
